...
namespace DalTest
{
    internal class Program
    {
        ...
        private static void mainMenu()
        {
            ...
            {
                Console.WriteLine
              (@"write what you choose: exit, task, engineer or link");
        ...
        private static void secondMenu(string? choice)
        {
            string? act;
            Console.WriteLine
            (@$" write what you choose: end, add {choice}, read {choice} ,readAll {choice}s, update {choice} or delete {choice}");
        ...
        private static void update(string? choice)
        {
            ...
            switch (choice)
            {
                ...
                case "engineer":
                    ...
                    string email = Console.ReadLine();
                    Console.WriteLine("enter engineer level");
                    EngineerLevel engLevel = (EngineerLevel)int.Parse(Console.ReadLine());
                    Console.WriteLine("please enter cost per hour");
                    double costPerHour = double.Parse(Console.ReadLine());

                    DO.Engineer newEngineer = new DO.Engineer(engId, engName, email, engLevel, costPerHour);
