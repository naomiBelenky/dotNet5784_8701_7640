...
public static class Initialization
{
    ...
    private static void createTasks()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            dates[i] = new DateTime(2024, month, day);
        }
        ...
        tasks[4] = new Task(0, "Prototyping", "Build early-stage models", false, new DateTime(2023, 07, 1));
        ...
        tasks[13] = new Task(0, "AR Development", "Create AR applications", false, new DateTime(2023, 12, 4));
    ...
    private static void createLinks()
    {
        ...
        for (int i = 1; i < 19 && i != 5; i++)     //All the task without the first ( Prototyping) depended in the second task: CAD Modeling
        {
